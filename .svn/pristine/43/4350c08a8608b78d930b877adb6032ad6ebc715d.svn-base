...
public class MyExcelBuilder extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
       ...
       for (Object[] strings1 : excelList.getStrings()) {
            ...
            for (int i = 0; i < strings1.length; i++) {
                ...
                if(i == 4){
                	if(strings1[2] !=null && strings1[3] !=null){
                	Double temp = new Double(strings1[2].toString());
                	Double temp1 = new Double(strings1[3].toString());
                	Double cal=temp*100/temp1;
                	 if(cal<0){
                cell.setCellStyle(styles.get("black"));
                	 } else if(cal>0.0 && cal<=33){
                		 cell.setCellStyle(styles.get("red"));
                	 }
                	 else if(cal>33 && cal<=67){
                		 cell.setCellStyle(styles.get("yellow"));
                	 }
                	 else if(cal>67 && cal<=100){
                		 cell.setCellStyle(styles.get("green"));
                	 }
                	 else{
                		 cell.setCellStyle(styles.get("white"));
                	 }
                	}else{
...
//FileOutputStream stream;
    ...
    public ByteArrayOutputStream generateExcel(ExcelExportCommand excelList){
...
//FileOutputStream stream;
    ...
    public ByteArrayOutputStream generateExcelSalesInvoiceCustomerPo(ExcelExportCommand excelList){
